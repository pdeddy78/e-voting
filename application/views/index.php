...
<?php
	...
	function write_log($log){  
		 ...
		 $op=$time.' '.'Di laman depan '.$log.PHP_EOL;
		 $fp = @fopen(LOG, 'a');
		 $write = @fwrite($fp, $op);
		 @fclose($fp);
	}
...
?>
<!-- Mau diintip? Silahkan :3 -->
<!-- Script nggak diencrypt kok.. Nggak pelit 'kan saya :p -->
...
<html lang="en">
  <head>
	...
	<link href="<?php echo base_url()?>css/simptip-mini.css" rel="stylesheet" type="text/css" />
    ...
    <div id="main_navigation" class="dark_grey"> <!-- Main navigation start -->
        <div class="inner_navigation">
           <ul class="main">
				...
				<?php if($this->session->userdata('ROLE')==3 && $this->session->userdata('PILIH')==0) {?> 
