      ...
      <div class="inner_content">
        <div class="widgets_area">
			...
			<div class="row-fluid" id="isiContent">	
				<h3><p align="center">Terima kasih telah memberikan suara Anda.</h3>
				<center><img src="<?php echo base_url()?>img/loading.gif" border='0'>
				<?php header('Refresh: 3; url=../home/logout');?>				
			</div>
